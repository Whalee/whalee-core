//Modified copy of "github.com/jmoiron/jsonq"
//Thanks to Jason
package jsonq
...
func (j *JsonQuery) Int(s ...string) (int, error) {
	...
	return 0, fmt.Errorf("Expected numeric value for Int, got \"%v\" type %v\n", val, reflect.ValueOf(val).Type().Kind())
}
...
func (j *JsonQuery) Int64(s ...string) (int64, error) {
	...
	return 0, fmt.Errorf("Expected numeric value for Int64, got \"%v\" type %v\n", val, reflect.ValueOf(val).Type().Kind())
}

func (j *JsonQuery) Float64(s ...string) (float64, error) {
	val, err := rquery(j.blob, s...)
	if err != nil {
		return 0, err
	}
...
func (j *JsonQuery) String(s ...string) (string, error) {
	...
	return "", fmt.Errorf("Expected string value for String, got \"%v\" type %v\n", val, reflect.ValueOf(val).Type().Kind())
}
